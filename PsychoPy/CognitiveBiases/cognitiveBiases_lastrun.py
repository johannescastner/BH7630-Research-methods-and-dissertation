...
expName = 'cognitiveBiases'  # from the Builder filename that created this script
expInfo = {
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\johan\\Desktop\\Kingston\\PsychoPy\\GithubRepo\\BH7630-Research-methods-and-dissertation\\PsychoPy\\CognitiveBiases\\cognitiveBiases_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    # --- Initialize components for Routine "ScenarioPresentation" ---
    text = visual.TextStim(win=win, name='text',
        text='Any text\n\nA wildfire is approaching a small town. Do you order an immediate evacuation or wait for further information from firefighters on the ground?\n',
        font='Open Sans',
    ...
    trials = data.TrialHandler(nReps=5.0, method='random', 
        ...
        trialList=data.importConditions('C:/Users/johan/Desktop/Kingston/PsychoPy/GithubRepo/BH7630-Research-methods-and-dissertation/PsychoPy/CognitiveBiases/conditions.csv'),
    ...
    for thisTrial in trials:
        ...
        # --- Prepare to start Routine "ScenarioPresentation" ---
        continueRoutine = True
        # update component parameters for each repeat
        thisExp.addData('ScenarioPresentation.started', globalClock.getTime())
        key_resp.keys = []
        key_resp.rt = []
        _key_resp_allKeys = []
        # keep track of which components have finished
        ScenarioPresentationComponents = [text, key_resp]
        for thisComponent in ScenarioPresentationComponents:
        ...
        # --- Run Routine "ScenarioPresentation" ---
        ...
        # --- Ending Routine "ScenarioPresentation" ---
        for thisComponent in ScenarioPresentationComponents:
            if hasattr(thisComponent, "setAutoDraw"):
                thisComponent.setAutoDraw(False)
        thisExp.addData('ScenarioPresentation.stopped', globalClock.getTime())
        # check responses
    ...
    _rating_allKeys = []
    # keep track of which components have finished
    RatingsComponents = [text_2, rating]
